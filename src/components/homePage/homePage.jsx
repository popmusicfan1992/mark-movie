...
import logo from "../../assets/images/marklogo.png";
import "./homePage.css";
               ...
               <div className="contentHome--email">
                  <div className="contentHome--email__input">
                     <label className="input_id" placeholder="email">
                        ...
                        >
                           <TextValidator className="nfTextField error" id="id_email_hero_fuji" tabindex="0" autocomplete="email" maxlength="50" minlength="5" placeholder="Địa chỉ email" variant="outlined" margin="normal" fullWidth onChange={handleEmail} pattern="[A-Za-z]{3}" title="Three letter country code" name="email" value={email} validators={["required", "isEmail"]} errorMessages={["Hãy điền trường này!!!", "email không hợp lệ"]} autoComplete="off" />

                           <button className="signinHome" onClick={handleClickButton}>
                              <a className="signinHome--a">
                                 Đăng ký
                  ...
                  <div id className="inputError" data-uia="field-email+error" style={{display: "none"}}>
                     Bạn cần nhập email!
                  </div>
               </div>
            </section>
