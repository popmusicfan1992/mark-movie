...
import imgCast from "../../../src/assets/images/me.jpg";
                  ...
                  <div className="col-md-6 col-lg-6 d-flex justify-content-between flex-column">
                     ...
                     <div className="detailPage--info__casts">
                        ...
                        <div className="detailPage--info__cast">
                           ...
                           <div className="detailPage--info__cast-name">Mark Huỳnh</div>
                        </div>
                     </div>
                  </div>
                  <div className="col-md-6 col-lg-6">
                     <div className="detailPage--info__details">
                        ...
                        <div className="detailPage--info__detail">
                           ...
                           <div className="detailPage--info__detail-right">Mark</div>
                        </div>
                        <div className="detailPage--info__detail">
                        ...
                        <div className="detailPage--info__detail">
                           ...
                           <div className="detailPage--info__detail-right">Hành động-Hồi Hộp-Gây Cấn-Tâm Lý</div>
                        </div>
                        <div className="detailPage--info__detail">
                        ...
                        <div className="detailPage--info__detail">
                           ...
                           <div className="detailPage--info__detail-right">120 phút+</div>
                        </div>
                        <div className="detailPage--info__detail">
                           <div className="detailPage--info__detail-left">Độ tuổi</div>
                           <div className="detailPage--info__detail-right">17+</div>
                        </div>
                        <div className="detailPage--info__detail">
