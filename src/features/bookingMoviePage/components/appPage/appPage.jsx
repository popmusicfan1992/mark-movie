...
import logoApp from "../../../../assets/images/marklogo.png";
         ...
         <div className="container">
            <div className="row">
               ...
               <div className="appView_right col-md-7 col-lg-7">
                  <div className="appView_content">Tải App về điện thoại của bạn để có trải nghiệm dễ dàng hơn .</div>
                  <div className="appView_small">Ứng dụng đặt vé xem phim hàng đầu Việt Nam , với giao diện dễ nhìn , đơn giản giúp khách hàng dễ dàng thao tác .Vui lòng tải ứng dụng để có được trải nghiệm tốt nhất</div>
