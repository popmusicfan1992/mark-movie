...
import logo2 from "../../../../assets/images/marklogo.png";
      ...
      <div className="pageViewer">
         <div className="container d-flex justify-content-between flex-column align-items-center">
            <div className="pageViewer--content d-flex justify-content-between flex-column align-items-center">
               <div className="pageViewer--content_-logo">
                  <img src={logo2} alt="" />
               </div>
               ...
               <div className="pageViewer--search">
                  <input className="pageViewer--search__input" type="text" placeholder="Search" onChange={handleChangeSearch} />
               </div>
            </div>
            <div className="row pageViewer--listMovieNow">
               {(array ? array : [])
                  .filter((movie) => {
                     if (NGAY_HOM_NAY <= Date.parse(movie.ngayKhoiChieu) && Date.parse(movie.ngayKhoiChieu) <= NGAY_KET_THUC && search === "") {
                        return movie;
                     } else if (search !== "") {
                        return movie.tenPhim.toLowerCase().includes(search.toLowerCase()) && NGAY_HOM_NAY <= Date.parse(movie.ngayKhoiChieu) && Date.parse(movie.ngayKhoiChieu) <= NGAY_KET_THUC;
                     }
                  })
                  .map((movie) => {
                     if (movie) {
                           ...
                           <div key={movie.maPhim} className="pageViewer--movies col-md-3 col-lg-3">
                              <div className="pageViewer--movie--full">
                                 ...
                                 <div className="pageViewer--movieContent--full">
                                    ...
                                    <Link onClick={handleClickBook} to={`/thong-tin-phim/${movie?.maPhim}`} className="pageViewer--listMovie__button listMovie--booking-button d-flex justify-content-center align-items-center">
                                       Book Now
                                    </Link>
                                 </div>
                              </div>
                        ...
                        return <div className="pageViewer--movies col-md-3 col-lg-3">hihi</div>;
                     }
                  })}
            </div>
            <div className="pageViewer--button">
               <div className="pageViewer--button__all" onClick={handleViewAll}>
                  <div className="pageViewer--bonus">Xem Thêm</div>
